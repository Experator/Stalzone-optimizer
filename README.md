...
- Кнопка Проверить пинг: покажет пниг и потерю пакетов (Может отличаться от итогового результата в игре)
- Кнопка Применить туннели: применяются все галочки, то-есть если туннель был заблокирован и на нем нету активной галочки, то он разблокируется и наоборот.
